...
class LimitSpec extends Specification {
    ...
    void "amount limit tests"(Quantity qt, MonetaryAmount price, MonetaryAmount coPayment, Quantity consumedQt, MonetaryAmount consumedAmount, BigDecimal amount) {
        expect:
    ...
    void "qt limit tests"(Quantity qt, MonetaryAmount price, MonetaryAmount coPayment, Quantity consumedQt, MonetaryAmount consumedAmount, BigDecimal amount) {
        expect:
